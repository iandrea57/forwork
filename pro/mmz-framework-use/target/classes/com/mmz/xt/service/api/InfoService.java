...
public class InfoService {
  ...
  public interface Iface {
    ...
    public GetInfoResponse getInfo(GetInfoRequest request) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void getInfo(GetInfoRequest request, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public GetInfoResponse getInfo(GetInfoRequest request) throws org.apache.thrift.TException
    {
      send_getInfo(request);
      return recv_getInfo();
    }

    public void send_getInfo(GetInfoRequest request) throws org.apache.thrift.TException
    {
    ...
    public GetInfoResponse recv_getInfo() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getInfo(GetInfoRequest request, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getInfo_call method_call = new getInfo_call(request, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getInfo_call extends org.apache.thrift.async.TAsyncMethodCall {
      private GetInfoRequest request;
      public getInfo_call(GetInfoRequest request, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public GetInfoResponse getResult() throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getInfo<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getInfo_args> {
      ...
      public getInfo_result getResult(I iface, getInfo_args args) throws org.apache.thrift.TException {
        getInfo_result result = new getInfo_result();
        result.success = iface.getInfo(args.request);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getInfo<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getInfo_args, GetInfoResponse> {
      public getInfo() {
        super("getInfo");
      }
      ...
      public AsyncMethodCallback<GetInfoResponse> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<GetInfoResponse>() { 
          public void onComplete(GetInfoResponse o) {
            getInfo_result result = new getInfo_result();
            result.success = o;
            try {
      ...
      public void start(I iface, getInfo_args args, org.apache.thrift.async.AsyncMethodCallback<GetInfoResponse> resultHandler) throws TException {
        iface.getInfo(args.request,resultHandler);
      }
    }
  ...
  public static class getInfo_args implements org.apache.thrift.TBase<getInfo_args, getInfo_args._Fields>, java.io.Serializable, Cloneable, Comparable<getInfo_args>   {
    ...
    public GetInfoRequest request; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.REQUEST, new org.apache.thrift.meta_data.FieldMetaData("request", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, GetInfoRequest.class)));
    ...
    public getInfo_args(getInfo_args other) {
      if (other.isSetRequest()) {
        this.request = new GetInfoRequest(other.request);
      }
    }
    ...
    public getInfo_args setRequest(GetInfoRequest request) {
      this.request = request;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case REQUEST:
        if (value == null) {
          ...
          setRequest((GetInfoRequest)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 1: // REQUEST
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.request = new GetInfoRequest();
  ...
  public static class getInfo_result implements org.apache.thrift.TBase<getInfo_result, getInfo_result._Fields>, java.io.Serializable, Cloneable, Comparable<getInfo_result>   {
    ...
    public GetInfoResponse success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, GetInfoResponse.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public getInfo_result(getInfo_result other) {
      if (other.isSetSuccess()) {
        this.success = new GetInfoResponse(other.success);
      }
    }
    ...
    public GetInfoResponse getSuccess() {
      return this.success;
    }

    public getInfo_result setSuccess(GetInfoResponse success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((GetInfoResponse)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getInfo_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new GetInfoResponse();
